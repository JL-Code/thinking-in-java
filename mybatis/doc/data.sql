DROP TABLE cloud_invitation_user_agent;
CREATE TABLE `cloud_invitation_user_agent` (
...
select * from cloud_invitation_user_agent;
...
select t1.nick_name,t1.id,t1.name,t2.agent_id,t2.create_time from cloud_user t1 
...
on t1.id = t2.user_id 
where t2.agent_id='75488aad-1692-4f66-a2df-4ae5f5716ae8' LIMIT 2
